...
@Composable
fun FrozenFoodsScreen(
    viewModel: FrozenFoodsViewModel = viewModel(),
        ...
        LazyVerticalGrid(
            ...
            item(span = { GridItemSpan(maxLineSpan) }) {
                Column(
                    ...
                    Text(
                        text = "Freshly frozen, delivered fast.",
